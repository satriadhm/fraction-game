...
const Step2 = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-100 p-8">
      ...
      <SwipeableContent contents={["Perkalian pecahan dilakukan dengan mengalikan pembilang dan penyebut.", "Pembagian pecahan dilakukan dengan mengalikan dengan kebalikannya."]} />
